...
|---|---|---|---|---|---|
| FHIR-33050 | FHIRVersion value set is missing codes | Published | `fhir-fork/source/ (determine exact file from ticket context)` | technical correction | Resolution: Persuasive. Ticket specifics: (none specified) |
