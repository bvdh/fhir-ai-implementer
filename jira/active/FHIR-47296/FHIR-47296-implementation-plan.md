...
|---|---|---|---|---|---|
| FHIR-47296 | Invariant contains misspelled "SAHLL" | Resolved - change required | `fhir-fork/source/ (determine exact file from ticket context)` | wording/typo correction | Resolution: Persuasive. Ticket specifics: (none specified) |
