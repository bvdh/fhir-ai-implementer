...
|---|---|---|---|---|---|
| FHIR-48872 | Title and curating work group of the Metadata Types page | Resolved - change required | `fhir-fork/source/ (determine exact file from ticket context)` | wording/typo correction | Resolution: Persuasive. Ticket specifics: (none specified) |
