...
|---|---|---|---|---|---|
| FHIR-44473 | Correct ExampleScenario spelling | Resolved - change required | `fhir-fork/source/ (determine exact file from ticket context)` | wording/typo correction | Resolution: Persuasive. Ticket specifics: (none specified) |
