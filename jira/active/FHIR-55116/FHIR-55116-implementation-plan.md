...
|---|---|---|---|---|---|
| FHIR-55116 | Spelling/abbreviation issues on page: operations | Resolved - change required | `fhir-fork/source/operations*` | wording/typo correction | Resolution: Persuasive. Ticket specifics: "doesn't" |
