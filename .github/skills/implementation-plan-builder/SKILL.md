...
- Markdown implementation plans in jira/wg/, defaulting to per-ticket plan files.
- Default output naming:
  - jira/wg/<ticket>-implementation-plan.md for ticket-key input
  - jira/wg/<workgroup>-implementation-plan.md for rollup-driven scope
  - jira/wg/<batch-name>-implementation-plan.md when explicitly requested as consolidated
...
- /implementation-plan-builder jira/wg/fmg.md
- /implementation-plan-builder FHIR-51010
- /implementation-plan-builder FHIR-51010,FHIR-51011,FHIR-51012
- /implementation-plan-builder "tickets from currentTickets.md"
